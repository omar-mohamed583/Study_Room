...
const getFontValue = (value: number | string): string =>
...
const syncUniforms = (program: Program, props: UniformProps): void => {
...
const WarpText = ({
  ...
  const propsRef = useRef<TextRenderProps & UniformProps>({
    text,
    color,
    fontSize,
    fontWeight,
